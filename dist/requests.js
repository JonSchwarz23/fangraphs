...
exports.FangraphsClient = void 0;
...
class FangraphsClient {
    constructor() { }
    async getMajorLeagueBattingLeaders(params = {}) {
    ...
    async getMajorLeaguePitchingLeaders(params = {}) {
        const url = new URL(urls_1.default.leaders);
...
exports.FangraphsClient = FangraphsClient;
